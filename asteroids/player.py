...
# At the top of your player.py file, after imports:
print("Constants imported:", dir())
print("SHOT_RADIUS:", SHOT_RADIUS)  # This should show the value
...
class Player(CircleShape):
    ...
    # Set shot velocity in the direction the player is facing
